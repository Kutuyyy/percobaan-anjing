...
local function createUI()
    ...
    -- SAPLING SYSTEM
    local saplingTab = Window:Tab({ Title = "Sapling", Icon = "sprout" })
   ...
   -- Plant Mode Section
    ...
    saplingTab:Section({ Title = "Plant Settings" })
    ...
    saplingTab:Section({ Title = "Log Wall System" })
    ...
    saplingTab:Toggle({
        ...
        Default = true,
        Callback = function(v)
            -- Variabel untuk menyimpan setting
            autoRotateLogWall = v
        end
    })
    ...
    -- AUTO CHEST OPENER TAB
    local chestTab = Window:Tab({ Title = "Chest Opener", Icon = "package" })

    chestTab:Section({ Title = "Auto Open All Chest" })
    ...
    chestTab:Section({ Title = "Chest Info" })

    -- Label untuk menampilkan info chest
    local chestInfoLabel = chestTab:Label({
