...
local function main()
    ...
    ---------------------------------------------------------
    -- BRING SETTINGS (FIXED - PAKAI BringItemAPI)
    ---------------------------------------------------------
    ;(function()
        ...
        do
            ...
            sec:Dropdown({
                Title = "Pilih Cultist",
                Values = list,
                Value = {"Crossbow Cultist","Cultist"},
                Multi = true,
                AllowNone = true,
                Callback = function(v)
                    sel = v or {"All"}
            ...
            sec:Button({
                Title = "Bring Cultist",
                Callback = function()
                    BringItemAPI.BringItems(list, sel, selectedLocation)
                end
            })
        end
        ...
        do
            ...
            sec:Dropdown({
                Title = "Pilih Fuel",
                Values = list,
                Value = {"Coal","Fuel Canister","Oil Barrel","Cultist","Crossbow Cultist"},
                Multi = true,
                AllowNone = true,
                Callback = function(v)
                    sel = v or {"All"}
            ...
            sec:Button({
                ...
                Callback = function()
                    BringItemAPI.BringItems(list, {"Log"}, selectedLocation)
                end
            })
        end
    ...
    ;(function()
        ...
        funTab:Slider({
            ...
            Step = 1,
            Value = { Min = 1, Max = 10, Default = angleIncrement or 2 },
            Callback = function(v)
        ...
        funTab:Slider({
            ...
            Step = 1,
            Value = { Min = 10, Max = 200, Default = overlayRadius or 40 },
            Callback = function(v)
        ...
        funTab:Slider({
            ...
            Step = 0.5,
            Value = { Min = 0, Max = 100, Default = overlayHeight or 3 },
            Callback = function(v)
                overlayHeight = v
                if overlayVisible then updateOverlay() end
            end
        ...
        funTab:Button({
            ...
            Callback = function()
                ...
                if count > 0 then
                    showWindUINotification("Log Wall System", "✅ Ditemukan "..count.." Log Wall Blueprint!", "Success", 4)
                else
                    showWindUINotification("Log Wall System", "✗ Tidak ada Log Wall Blueprint di inventory!", "Error", 4)
                end
            end
        })
        ...
        funTab:Slider({
            ...
            Step = 0.1,
            Value = { Min = 0.3, Max = 1, Default = chestOpeningSpeed or 0.3 },
            Callback = function(v)
        ...
        funTab:Button({
            ...
            Callback = function()
                ...
                if count > 0 then
                    showWindUINotification("Chest Scanner", "Ditemukan "..count.." chest!", "Success", 3)
                else
                    showWindUINotification("Chest Scanner", "Tidak ada chest ditemukan", "Warning", 3)
                end
            end
        })
        ...
        funTab:Button({
            ...
            Callback = function()
                if not isOpeningChests then
                    ...
                    showWindUINotification("Chest Opener", "Sedang membuka chest.", "Info", 2)
                end
            end
        })
        ...
        -- Contoh notifikasi WindUI saat startup (opsional)
        task.wait(1)
        showWindUINotification("FRENESIS", "Sistem berhasil dimuat!\nTekan F1 untuk toggle UI", "Success", 4)
    end)()
    ---------------------------------------------------------
